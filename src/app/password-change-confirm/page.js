  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, actions) => {
      try {
        ...
        const changePassword = await api.put('/auth/password_reset_confirm/', {
  ...
  return (
    <main className={styles.main}>
      <div className={styles.form}>
        ...
        {!changeStatus ? <form onSubmit={formik.handleSubmit} autoComplete='off'>
          ...
          <>
            ...
            <br></br>
            <button onClick={handleRedirect} type='submit'>Go to ligin</button>
